            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="card card-user" class="text-center">
                            ...
                            <div class="content">
                               ...
                               <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Observation</label>
                                        <input type="text" class="form-control border-input"  placeholder="Protocole" value="Creative Code Inc.">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Observation</label>
                                        <input type="text" class="form-control border-input"  placeholder="Medicament" value="Creative Code Inc.">
                                    </div>
                                </div>
                            </div>
                            <hr>
